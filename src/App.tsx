      ...
      <AuthProvider>
        <CardProvider>
          ...
          <Routes>
            ...
            <Route path="/card/:id" element={<Navigate to={params => `/cards/${params.id}`} replace />} />
            ...
            <Route path="/oakland/memories/:id" element={<Navigate to={params => `/teams/oakland/memories/${params.id}`} replace />} />
