...
const ImmersiveCardViewerPage: React.FC = () => {
  ...
  const [viewTab, setViewTab] = useState('effects'); // Set default tab to 'effects'
  const [isPanelOpen, setIsPanelOpen] = useState(true); // Set panel open by default
  ...
  return (
    ...
    >
      <div className="relative min-h-screen bg-gray-900/95">
        <div className={cn(
        ...
        <div className="flex relative z-10 min-h-[calc(100vh-56px)]">
          <div className={cn(
          ...
          <div className={cn(
            "fixed right-0 top-[56px] bottom-0 w-[320px] bg-gray-900/95 backdrop-blur-lg border-l border-gray-800 transition-all duration-300 overflow-y-auto",
