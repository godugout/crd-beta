  ...
  const filteredCardsByTab = useMemo(() => {
    ...
    switch (activeTab) {
      ...
      case 'favorites':
        ...
        break;
      case 'collections':
        // Show cards that are part of collections
        filtered = allCards.filter(card => card.collectionId);
        break;
      case 'all':
      default:
        filtered = allCards;
  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-7xl px-4 py-6">
        ...
        {/* Top Toolbar with Tabs and Controls */}
        <div className="mb-6">
          ...
          {showFilters && (
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 space-y-4 border mb-4">
          ...
          {selectedCards.length > 0 && (
            <div className="mb-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
...
export default UnifiedCardGalleryPage;
